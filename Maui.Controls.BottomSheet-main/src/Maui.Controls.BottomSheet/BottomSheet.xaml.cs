...
public partial class BottomSheet : ContentView
{
    ...
    public class BottomSheetClosedEventArgs : EventArgs
    {
        public bool Message { get; set; }

        public BottomSheetClosedEventArgs(bool message)
        {
            Message = message;
        }
    }
    ...
    public async Task CloseBottomSheet()
    {
        ...
        WeakReferenceMessenger.Default.Send(new BottomSheetClosedMessage(true));
    }
